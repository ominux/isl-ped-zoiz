...
bitline.
%Furthermore, we also notice that when the array has the same number of wordlines and bitlines, FWFB, HWFB and FWHB schemes have the same minimum driven voltage.
...
%Intuitively, the impact of sneak paths for floating schemes (FWHB and
%HWFB) is more serious, the energy consumed at unselected cells for
%floating schemes should be larger than the HWHB scheme. However, our
%simulation results show that compared to the total energy consumption, the
...
%of HWHB scheme. In addition, as mentioned, the voltage drop results for
%these schemes are also similar, in the following discussion, we only show
%the simulation results of HWHB scheme. The results for the other two
%schemes have the same trend as that of HWHB scheme.
